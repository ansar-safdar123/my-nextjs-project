...
export default function FairnessCard({
  ...
  return (
    <div
      className="relative w-xs sm:w-sm font-exo italic cursor-pointer"
      onClick={onClick}
    >
      <motion.div
        layout
        transition={{ layout: { duration: 0.5, ease: "easeInOut" } }}
        className={`hover:overflow-hidden hover:rounded-xl hover:shadow-lg hover:bg-[#000008]/20 hover:backdrop-blur-lg transition-all duration-700 ${
          isActive
      ...
      >
        <div
          className={`flex flex-col sm:flex-row justify-center sm:justify-start  min-w-full items-center ${
              ...
              {isActive && (
                ...
                >
                  <div className="flex font-teko text-[17px] uppercase justify-center gap-3">
                    <button className="px-4 py-1 text-white rounded-full transition-all duration-200 bg-[#00000080] border border-gray-500 hover:text-white hover:bg-gray-700">
                      View Set
                    </button>
                    <button className="px-4 py-1 text-white rounded-full transition-all duration-200 bg-[#00000080] border border-gray-500 hover:text-white hover:bg-gray-700">
                      Shop
