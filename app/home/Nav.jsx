...
//     const directDiff = targetScroll - currentScroll;
//     const wrappedDiff =
//       directDiff > 0 ? directDiff - singleSetWidth : directDiff + singleSetWidth;

//     const finalScroll =
//       Math.abs(directDiff) < Math.abs(wrappedDiff)
//         ? targetScroll
//         : currentScroll + wrappedDiff;
...
//       // Add active/deActive animations after scroll completes
//       setTimeout(() => {
//         allItems.forEach((i) => {
//           if (Number(i.dataset.index) === clickedIndex) {
//             i.classList.add("active");
...
//         // Trigger callback
//         if (onMenuChange) onMenuChange(clickedIndex);

//         isRepositioning = false;
//         isClicking = false;
//       }, 50); // Delay matches scroll duration
//     });
//   });
...
//     isDown = true;
//     startX = e.pageX - menuContainer.offsetLeft;
//     scrollLeftDrag = menuContainer.scrollLeft;
//     menuContainer.classList.add("dragging");
//     menuContainer.style.scrollBehavior = "auto";
//   };
//   const handleMouseLeave = () => {
...
//     const x = e.pageX - menuContainer.offsetLeft;
//     const walk = (x - startX) * 1.5;
//     menuContainer.scrollLeft = scrollLeftDrag - walk;
//   };
